    ...
    <div className="flex items-center gap-3 bg-slate-50 px-3 py-1.5 rounded-full border border-slate-200 shadow-sm">
      ...
      <div className="flex items-center gap-1.5">
        ...
        >
          ...
          <option value="de" className="text-slate-900 bg-white">Deutsch</option>
          <option value="pl" className="text-slate-900 bg-white">Polski</option>
          <option value="cs" className="text-slate-900 bg-white">Čeština</option>
        </select>
      </div>
